    ...
    <>
      <nav className="side-nav" aria-label="Site navigation" ref={railRef}>
        <div className="side-nav__top">
          ...
          >
            <img ref={navLogoRef} src={logo} alt="" className="side-nav__logo-img" />
          </button>
        </div>
      ...
      <div className="social-rail" aria-label="Social links">
        <a href="#" className="social-rail__btn" aria-label="Twitter / X">{ICON_TW}</a>
        <a href="#" className="social-rail__btn" aria-label="Discord">{ICON_DC}</a>
        <a href="#" className="social-rail__btn" aria-label="YouTube">{ICON_YT}</a>
      </div>
    </>
  );
}
